import { ButtonCommon, StatusModal, ConfirmLogout, ConfirmResetSettings, ConfirmDelete, CommonModal } from "@tnbt-style-custom";
...
export default function CustomModalExample() {
  ...
  return (
    <div>
      <div className="my-2.5 font-[500] text-[18px]">Modal box display data as info/status</div>
      ...
      <div className="my-2.5 font-[500] text-[18px]">Modal box for comfirm and continue action</div>
      <div className="flex gap-3 my-2.5">
