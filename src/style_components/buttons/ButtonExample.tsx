...
import { GradientButton, ButtonBorderGradient, ButtonCommon, icons, GroupButton } from "@tnbt-style-custom";
import { FaCheck } from "react-icons/fa6";
import { RiEditFill } from "react-icons/ri";
export default function ButtonExample() {
  return (
    <div>
      <div className="font-600 text-[24px] my-2.5">Custom gradients with hover effect</div>
      ...
      <div className="font-600 text-[24px] my-2.5">Custom button with gradient border</div>
      <div className="flex gap-2.5">
      ...
      <div className="font-600 text-[24px] my-2.5">Custom button with hover background</div>
      <div className="flex gap-2.5">
      ...
      <div className="font-600 text-[24px] my-2.5">Custom button with icons</div>
      <div className="flex gap-2.5">
