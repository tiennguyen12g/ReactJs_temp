import { TableWithDragColumn, TableWithResizeColumn, TableCommon, type TableHeader } from "@tnbt-style-custom";
...
export default function TableExample() {
  ...
  return (
    <div>
      ...
      <div className="mb-2.5 mt-2.5">The value in the cell can align to left; center or right</div>
